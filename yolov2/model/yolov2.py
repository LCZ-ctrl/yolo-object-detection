...
class YOLOv2(nn.Module):
    def __init__(self, device, input_size=None, num_classes=20, trainable=False, conf_thresh=0.005, nms_thresh=0.6,
    ...
    def postprocess(self, obj_pred, cls_pred, reg_pred, anchors):
        ...
        scores = torch.sqrt(obj_pred.sigmoid() * cls_pred.sigmoid()).flatten()  # [M*C]
